...
# wget https://raw.githubusercontent.com/Supraconductor/azure-quickstart-templates/master/cloudera-on-centos/Repo/cloudera-manager.repo -O /etc/yum.repos.d/cloudera-manager.repo >> /tmp/initialize-cloudera-server.log
